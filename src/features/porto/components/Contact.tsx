            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 auto-rows-[180px] md:auto-rows-[220px]">
              {socials.map((item, i) => (
                <motion.a
                  ...
                  viewport={{ once: true }}
                  className={`group relative flex flex-col justify-between p-8 md:p-12 rounded-md border border-foreground/10 shadow-sm hover:scale-[1.02] hover:rotate-1 active:scale-97 transition-[transform,box-shadow,background-color] duration-300 ease-out-custom overflow-hidden ${item.size} ${item.color}`}
                >
